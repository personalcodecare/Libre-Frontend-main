...
import { Token, ChainId } from '@libre-defi/bsc-swap-sdk';
...
const ImportModal: React.FC<ImportModal> = ({
  ...
  const { exchangeState, addExchangeToken } = useExchangeFacade();
  const { tokens: tokenList } = exchangeState;
